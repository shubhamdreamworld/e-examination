...
<title>SHUBHAM e-Examination</title>
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="SHUBHAM" width="400" height="300">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>College Students</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Competative Exam Aspirants</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Ranjan</span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 7011322673 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> shubh971797@gmail.com</p>
    </div>
